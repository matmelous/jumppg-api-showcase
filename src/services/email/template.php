...
function sendToken($recieverName='teste', $recieverEmail='teste@gmail.com', $token='token')
{
	$titulo = 'Jump PG';
 	$nomeRem = 'auto';
	$emailRem = 'auto';
...
';*/
	...
	$novaslinhas = '';
	$linklogo = 'https://api.jumppg.com.br/src/assets/Logo Dark.png';
	// $linklogo = '\jumppg-api\src\assets\Logo Dark.png';
