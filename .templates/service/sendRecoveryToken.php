...
function sendRecoveryToken($recieverName, $recieverEmail, $token)
{
	$titulo = 'Jump PG';
 	$nomeRem = 'auto';
	$emailRem = 'auto';
	...
	$mensagem1 = 'Confirma teu endereço de e-mail para recuperar a sua conta.
'; 
	$linkbtn1 = 'https://jumppg.com.br/recuperar-senha/?token='.$token.'';
	$textobtn1 = 'CONFIRMAR O ENDEREÇO DE E-MAIL';
